...
public class Chessboard : MonoBehaviour
{
    ...
    [SerializeField] private UnityEngine.XR.Interaction.Toolkit.Interactors.XRDirectInteractor whiteInteractor;    // right hand of player White
    ...
    private void TakeInput(SelectEnterEventArgs args)
    {
        ...
        Debug.LogWarning("Selected object is not a chess piece or it is not your turn to move.");
