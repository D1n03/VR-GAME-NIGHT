...
public class SpawnCards : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (TryGetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable>(out interactable))
        {
    ...
    void TakeCard(SelectEnterEventArgs arg)
    {
        ...
        var xrInteractable = pivotPoint.AddComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable>();
