...
namespace Keyboard
{
    public class KeyboardManager : MonoBehaviour
    {
        ...
        public UnityEvent<string> onEnterPressed;
        ...
        private void Awake()
        {
            ...
            if (onEnterPressed == null)
                onEnterPressed = new UnityEvent<string>();
        }
        ...
        {
            string enteredText = outputField.text.Trim();
            if (enteredText.Length >= minCharacters)
            {
                onEnterPressed.Invoke(enteredText);
                // Optionally clear the field after entering the name
